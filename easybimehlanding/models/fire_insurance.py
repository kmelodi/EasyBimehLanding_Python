...
import easybimehlanding.models.insurance_extra_coverage
...
class FireInsurance(object):

    """Implementation of the 'FireInsurance' model.
    ...
    Attributes:
        ...
        insurance_policy_terms (list of InsurancePolicyTerm): TODO: type
            description here.
        insurance_extra_coverage (list of InsuranceExtraCoverage): TODO: type
            description here.
    ...
    def __init__(self,
                 ...
                 insurance_data=None):
        """Constructor for the FireInsurance class"""
    ...
    def from_dictionary(cls,
        ...
        insurance_extra_coverage = None
        if dictionary.get('insuranceExtraCoverage') != None:
            insurance_extra_coverage = list()
            for structure in dictionary.get('insuranceExtraCoverage'):
                insurance_extra_coverage.append(easybimehlanding.models.insurance_extra_coverage.InsuranceExtraCoverage.from_dictionary(structure))
        every_square_meter_coverage = None
