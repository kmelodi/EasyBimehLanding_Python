...
import easybimehlanding.models.elevator_insurance_policy_extend_view
import easybimehlanding.models.elevator_insurance_policy_filter

class InsuranceDataElevatorInsurance(object):

    """Implementation of the 'InsuranceData ElevatorInsurance' model.

    TODO: type model description here.

    Attributes:
        elevator_insurance_policy_extend_view
            (ElevatorInsurancePolicyExtendView): TODO: type description here.
        elevator_insurance_policy_filter (ElevatorInsurancePolicyFilter):
    ...
    _names = {
        "elevator_insurance_policy_extend_view":'elevatorInsurancePolicyExtendView',
        "elevator_insurance_policy_filter":'elevatorInsurancePolicyFilter',
        "id":'id',
    ...
    def __init__(self,
                 elevator_insurance_policy_extend_view=None,
                 elevator_insurance_policy_filter=None,
                 id=None,
        ...
        """Constructor for the InsuranceDataElevatorInsurance class"""

        # Initialize members of the class
        self.elevator_insurance_policy_extend_view = elevator_insurance_policy_extend_view
        self.elevator_insurance_policy_filter = elevator_insurance_policy_filter
        self.id = id
    ...
    def from_dictionary(cls,
        ...
        elevator_insurance_policy_extend_view = easybimehlanding.models.elevator_insurance_policy_extend_view.ElevatorInsurancePolicyExtendView.from_dictionary(dictionary.get('elevatorInsurancePolicyExtendView')) if dictionary.get('elevatorInsurancePolicyExtendView') else None
        elevator_insurance_policy_filter = easybimehlanding.models.elevator_insurance_policy_filter.ElevatorInsurancePolicyFilter.from_dictionary(dictionary.get('elevatorInsurancePolicyFilter')) if dictionary.get('elevatorInsurancePolicyFilter') else None
        ...
        return cls(elevator_insurance_policy_extend_view,
