...
class ExtraDataBaseModelSpecialPlan(object):

    """Implementation of the 'ExtraData Base Model SpecialPlan' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ExtraDataBaseModelSpecialPlan class"""
