...
import easybimehlanding.models.divice_franchisee

class BaseModelDiviceFranchisee(object):

    """Implementation of the 'Base Model DiviceFranchisee' model.
    ...
    Attributes:
        ...
        message (list of DiviceFranchisee): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 extra_data=None,
                 exception=None):
        """Constructor for the BaseModelDiviceFranchisee class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('message') != None:
            ...
            for structure in dictionary.get('message'):
                message.append(easybimehlanding.models.divice_franchisee.DiviceFranchisee.from_dictionary(structure))
