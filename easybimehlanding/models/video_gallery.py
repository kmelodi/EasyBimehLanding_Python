...
class VideoGallery(object):

    """Implementation of the 'VideoGallery' model.
    ...
    Attributes:
        ...
        popup_image_galleryies (list of string): TODO: type description here.
        gallery_details (list of string): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the VideoGallery class"""
    ...
    def from_dictionary(cls,
        ...
        popup_image_galleryies = dictionary.get('popupImageGalleryies')
        gallery_details = dictionary.get('galleryDetails')
