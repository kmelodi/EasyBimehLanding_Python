...
import easybimehlanding.models.tracking_code

class BaseModelTrakingCode(object):

    """Implementation of the 'Base Model TrakingCode' model.
    ...
    Attributes:
        ...
        message (list of TrackingCode): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 extra_data=None,
                 exception=None):
        """Constructor for the BaseModelTrakingCode class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('message') != None:
            ...
            for structure in dictionary.get('message'):
                message.append(easybimehlanding.models.tracking_code.TrackingCode.from_dictionary(structure))
