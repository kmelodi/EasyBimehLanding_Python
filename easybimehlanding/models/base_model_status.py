...
import easybimehlanding.models.status

class BaseModelStatus(object):

    """Implementation of the 'Base Model Status' model.
    ...
    Attributes:
        ...
        message (list of Status): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 extra_data=None,
                 exception=None):
        """Constructor for the BaseModelStatus class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('message') != None:
            ...
            for structure in dictionary.get('message'):
                message.append(easybimehlanding.models.status.Status.from_dictionary(structure))
