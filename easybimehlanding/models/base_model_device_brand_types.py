...
import easybimehlanding.models.device_brand_types

class BaseModelDeviceBrandTypes(object):

    """Implementation of the 'Base Model DeviceBrandTypes' model.
    ...
    Attributes:
        ...
        message (list of DeviceBrandTypes): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 extra_data=None,
                 exception=None):
        """Constructor for the BaseModelDeviceBrandTypes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('message') != None:
            ...
            for structure in dictionary.get('message'):
                message.append(easybimehlanding.models.device_brand_types.DeviceBrandTypes.from_dictionary(structure))
