...
import easybimehlanding.models.damage_type

class BaseModelDamageType(object):

    """Implementation of the 'Base Model DamageType' model.
    ...
    Attributes:
        ...
        message (list of DamageType): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 extra_data=None,
                 exception=None):
        """Constructor for the BaseModelDamageType class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('message') != None:
            ...
            for structure in dictionary.get('message'):
                message.append(easybimehlanding.models.damage_type.DamageType.from_dictionary(structure))
