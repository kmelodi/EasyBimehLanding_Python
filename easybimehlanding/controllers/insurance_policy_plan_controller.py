...
from easybimehlanding.models.base_model_special_plan import BaseModelSpecialPlan
...
class InsurancePolicyPlanController(BaseController):
    ...
    def get_special_plan(self,
                         sub_domain,
                         x_api_key):
        """Does a GET request to /InsurancePolicyPlan/SpecialPlan.
        ...
        Returns:
            BaseModelSpecialPlan: Response from the API. 
        ...
        # Prepare query URL
        _url_path = '/InsurancePolicyPlan/SpecialPlan'
        ...
        return APIHelper.json_deserialize(_context.response.raw_body, BaseModelSpecialPlan.from_dictionary)
