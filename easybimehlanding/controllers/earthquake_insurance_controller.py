...
from easybimehlanding.models.base_model_earthquake import BaseModelEarthquake
...
class EarthquakeInsuranceController(BaseController):
    ...
    def get_earthquake(self,
        ...
        Returns:
            BaseModelEarthquake: Response from the API. 
        ...
        return APIHelper.json_deserialize(_context.response.raw_body, BaseModelEarthquake.from_dictionary)
